...
Aplicação desktop que automatiza tarefas repetitivas da farmácia hospitalar dentro do ERP MV (SoulMV), sistema de grande porte usado em hospitais no Brasil. Rotinas que antes consumiam mais de uma hora dentro do sistema passaram a rodar em poucos cliques.
